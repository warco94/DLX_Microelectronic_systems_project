...
#  Created on Fri Aug 21 18:58:04 2020                
#                                                     
#######################################################
...
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -unit MICRON -spreadDirection clockwise -side Right -layer 1 -spreadType center -spacing 0.14 -pin DRAM_RW
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -unit MICRON -spreadDirection clockwise -side Right -layer 1 -spreadType center -spacing 0.14 -pin DRAM_ENABLE
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Right -layer 1 -spreadType side -pin {{DRAM_SEL[0]} {DRAM_SEL[1]} {DRAM_SEL[2]}}
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Bottom -layer 1 -spreadType side -pin {{DRAM_DATA_IN[0]} {DRAM_DATA_IN[1]} {DRAM_DATA_IN[2]} {DRAM_DATA_IN[3]} {DRAM_DATA_IN[4]} {DRAM_DATA_IN[5]} {DRAM_DATA_IN[6]} {DRAM_DATA_IN[7]} {DRAM_DATA_IN[8]} {DRAM_DATA_IN[9]} {DRAM_DATA_IN[10]} {DRAM_DATA_IN[11]} {DRAM_DATA_IN[12]} {DRAM_DATA_IN[13]} {DRAM_DATA_IN[14]} {DRAM_DATA_IN[15]} {DRAM_DATA_IN[16]} {DRAM_DATA_IN[17]} {DRAM_DATA_IN[18]} {DRAM_DATA_IN[19]} {DRAM_DATA_IN[20]} {DRAM_DATA_IN[21]} {DRAM_DATA_IN[22]} {DRAM_DATA_IN[23]} {DRAM_DATA_IN[24]} {DRAM_DATA_IN[25]} {DRAM_DATA_IN[26]} {DRAM_DATA_IN[27]} {DRAM_DATA_IN[28]} {DRAM_DATA_IN[29]} {DRAM_DATA_IN[30]} {DRAM_DATA_IN[31]}}
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Bottom -layer 1 -spreadType side -pin {{DRAM_DATA_OUT[0]} {DRAM_DATA_OUT[1]} {DRAM_DATA_OUT[2]} {DRAM_DATA_OUT[3]} {DRAM_DATA_OUT[4]} {DRAM_DATA_OUT[5]} {DRAM_DATA_OUT[6]} {DRAM_DATA_OUT[7]} {DRAM_DATA_OUT[8]} {DRAM_DATA_OUT[9]} {DRAM_DATA_OUT[10]} {DRAM_DATA_OUT[11]} {DRAM_DATA_OUT[12]} {DRAM_DATA_OUT[13]} {DRAM_DATA_OUT[14]} {DRAM_DATA_OUT[15]} {DRAM_DATA_OUT[16]} {DRAM_DATA_OUT[17]} {DRAM_DATA_OUT[18]} {DRAM_DATA_OUT[19]} {DRAM_DATA_OUT[20]} {DRAM_DATA_OUT[21]} {DRAM_DATA_OUT[22]} {DRAM_DATA_OUT[23]} {DRAM_DATA_OUT[24]} {DRAM_DATA_OUT[25]} {DRAM_DATA_OUT[26]} {DRAM_DATA_OUT[27]} {DRAM_DATA_OUT[28]} {DRAM_DATA_OUT[29]} {DRAM_DATA_OUT[30]} {DRAM_DATA_OUT[31]}}
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Bottom -layer 1 -spreadType side -pin {{DRAM_ADDRESS[0]} {DRAM_ADDRESS[1]} {DRAM_ADDRESS[2]} {DRAM_ADDRESS[3]} {DRAM_ADDRESS[4]} {DRAM_ADDRESS[5]} {DRAM_ADDRESS[6]} {DRAM_ADDRESS[7]} {DRAM_ADDRESS[8]} {DRAM_ADDRESS[9]} {DRAM_ADDRESS[10]} {DRAM_ADDRESS[11]}}
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Top -layer 1 -spreadType side -pin {{IRAM_ADDRESS[0]} {IRAM_ADDRESS[1]} {IRAM_ADDRESS[2]} {IRAM_ADDRESS[3]} {IRAM_ADDRESS[4]} {IRAM_ADDRESS[5]} {IRAM_ADDRESS[6]} {IRAM_ADDRESS[7]}}
setPinAssignMode -pinEditInBatch true
editPin -fixOverlap 1 -spreadDirection clockwise -side Top -layer 1 -spreadType side -pin {{IRAM_DATA_OUT[0]} {IRAM_DATA_OUT[1]} {IRAM_DATA_OUT[2]} {IRAM_DATA_OUT[3]} {IRAM_DATA_OUT[4]} {IRAM_DATA_OUT[5]} {IRAM_DATA_OUT[6]} {IRAM_DATA_OUT[7]} {IRAM_DATA_OUT[8]} {IRAM_DATA_OUT[9]} {IRAM_DATA_OUT[10]} {IRAM_DATA_OUT[11]} {IRAM_DATA_OUT[12]} {IRAM_DATA_OUT[13]} {IRAM_DATA_OUT[14]} {IRAM_DATA_OUT[15]} {IRAM_DATA_OUT[16]} {IRAM_DATA_OUT[17]} {IRAM_DATA_OUT[18]} {IRAM_DATA_OUT[19]} {IRAM_DATA_OUT[20]} {IRAM_DATA_OUT[21]} {IRAM_DATA_OUT[22]} {IRAM_DATA_OUT[23]} {IRAM_DATA_OUT[24]} {IRAM_DATA_OUT[25]} {IRAM_DATA_OUT[26]} {IRAM_DATA_OUT[27]} {IRAM_DATA_OUT[28]} {IRAM_DATA_OUT[29]} {IRAM_DATA_OUT[30]} {IRAM_DATA_OUT[31]}}
setPinAssignMode -pinEditInBatch true
editPin -pinWidth 0.07 -pinDepth 0.07 -fixOverlap 1 -spreadDirection clockwise -side Right -layer 1 -spreadType side -pin {{DRAM_ADDRESS[0]} {DRAM_ADDRESS[1]} {DRAM_ADDRESS[2]} {DRAM_ADDRESS[3]} {DRAM_ADDRESS[4]} {DRAM_ADDRESS[5]} {DRAM_ADDRESS[6]} {DRAM_ADDRESS[7]} {DRAM_ADDRESS[8]} {DRAM_ADDRESS[9]} {DRAM_ADDRESS[10]} {DRAM_ADDRESS[11]}}
setPinAssignMode -pinEditInBatch true
editPin -pinWidth 0.07 -pinDepth 0.07 -fixOverlap 1 -spreadDirection clockwise -side Right -layer 1 -spreadType side -pin {{DRAM_ADDRESS[0]} {DRAM_ADDRESS[1]} {DRAM_ADDRESS[2]} {DRAM_ADDRESS[3]} {DRAM_ADDRESS[4]} {DRAM_ADDRESS[5]} {DRAM_ADDRESS[6]} {DRAM_ADDRESS[7]} {DRAM_ADDRESS[8]} {DRAM_ADDRESS[9]} {DRAM_ADDRESS[10]} {DRAM_ADDRESS[11]}}
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix DLX_syn_postRoute_setup -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix DLX_syn_postRoute_hold -outDir timingReports
get_time_unit
