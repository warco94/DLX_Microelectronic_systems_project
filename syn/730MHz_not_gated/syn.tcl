...
# Clock setup
create_clock -name "CLK" -period 1.37 Clk
set_max_delay 1.37 -from [all_inputs] -to [all_outputs]

# Compilation step
compile_ultra -timing_high_effort_script

# Report and netlist production
report_timing -nworst 10 > timing_730MHz_not_gated.txt
report_power > power_730MHz_not_gated.txt
report_area > area_730MHz_not_gated.txt
