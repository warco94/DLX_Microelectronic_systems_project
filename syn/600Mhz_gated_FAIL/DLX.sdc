...
# Created by write_sdc on Fri Aug 21 01:16:37 2020

###################################################################
set sdc_version 1.9

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current mA
create_clock [get_ports Clk]  -name CLK  -period 1.67  -waveform {0 0.835}
set_max_delay 1.67  -from [list [get_ports Clk] [get_ports Rst] [get_ports {IRAM_DATA_OUT[31]}]   \
